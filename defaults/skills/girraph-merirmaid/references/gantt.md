<!-- Source: https://github.com/mermaid-js/mermaid/blob/develop/packages/mermaid/src/docs/syntax/gantt.md — Mermaid (https://mermaid.js.org), MIT License. Vendored for offline agent reference; syntax content only. -->
